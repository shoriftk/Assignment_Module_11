        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('product.sale')" :active="request()->routeIs('product.sale')">
                        {{ __('Sale') }}
                    </x-nav-link>
                    <x-nav-link :href="route('product.transactions')" :active="request()->routeIs('product.transections')">
                        {{ __('Transactions') }}
                    </x-nav-link>
                </div>
            </div>
